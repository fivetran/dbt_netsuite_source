...
{% set columns = [
    ...
    {"name": "_fivetran_deleted", "datatype": "boolean"},
    {"name": "_fivetran_synced", "datatype": dbt_utils.type_timestamp()},
    {"name": "alternatedemandsourceitem", "datatype": dbt_utils.type_float()},
    {"name": "assetaccount", "datatype": dbt_utils.type_float()},
    {"name": "averagecost", "datatype": dbt_utils.type_float()},
    {"name": "backwardconsumptiondays", "datatype": dbt_utils.type_float()},
    {"name": "consumptionunit", "datatype": dbt_utils.type_float()},
    ...
    {"name": "date_deleted", "datatype": dbt_utils.type_timestamp()},
    {"name": "deferralaccount", "datatype": dbt_utils.type_float()},
    {"name": "deferredrevenueaccount", "datatype": dbt_utils.type_float()},
    {"name": "department", "datatype": dbt_utils.type_float()},
    {"name": "description", "datatype": dbt_utils.type_string()},
    {"name": "dropshipexpenseaccount", "datatype": dbt_utils.type_float()},
    {"name": "expenseaccount", "datatype": dbt_utils.type_float()},
    {"name": "externalid", "datatype": dbt_utils.type_float()},
    {"name": "forwardconsumptiondays", "datatype": dbt_utils.type_float()},
    {"name": "fullname", "datatype": dbt_utils.type_string()},
    {"name": "gainlossaccount", "datatype": dbt_utils.type_float()},
    {"name": "handlingcost", "datatype": dbt_utils.type_float()},
    {"name": "incomeaccount", "datatype": dbt_utils.type_float()},
    {"name": "intercoexpenseaccount", "datatype": dbt_utils.type_float()},
    {"name": "intercoincomeaccount", "datatype": dbt_utils.type_float()},
    {"name": "isinactive", "datatype": dbt_utils.type_string()},
    {"name": "isphantom", "datatype": dbt_utils.type_string()},
    {"name": "isspecialorderitem", "datatype": dbt_utils.type_string()},
    {"name": "itemid", "datatype": dbt_utils.type_float()},
    {"name": "itemrevenuecategory", "datatype": dbt_utils.type_string()},
    ...
    {"name": "maximumquantity", "datatype": dbt_utils.type_float()},
    {"name": "minimumquantity", "datatype": dbt_utils.type_float()},
    {"name": "mpn", "datatype": dbt_utils.type_string()},
    {"name": "parent", "datatype": dbt_utils.type_float()},
    {"name": "revenuerecognitionrule", "datatype": dbt_utils.type_float()},
    {"name": "revrecforecastrule", "datatype": dbt_utils.type_float()},
    {"name": "roundupascomponent", "datatype": dbt_utils.type_string()},
    {"name": "saleunit", "datatype": dbt_utils.type_float()},
    {"name": "stockunit", "datatype": dbt_utils.type_float()},
    {"name": "subsidiary", "datatype": dbt_utils.type_float()},
    {"name": "subtype", "datatype": dbt_utils.type_string()},
    {"name": "supplyreplenishmentmethod", "datatype": dbt_utils.type_string()},
    {"name": "unitstype", "datatype": dbt_utils.type_float()},
    {"name": "upccode", "datatype": dbt_utils.type_string()},
    {"name": "vendorname", "datatype": dbt_utils.type_string()},
    {"name": "vendreturnvarianceaccount", "datatype": dbt_utils.type_float()},
    ...
    {"name": "weight", "datatype": dbt_utils.type_float()},
    {"name": "weightunits", "datatype": dbt_utils.type_float()},
    {"name": "wipacct", "datatype": dbt_utils.type_float()},
    {"name": "wipvarianceacct", "datatype": dbt_utils.type_float()}
] %}
