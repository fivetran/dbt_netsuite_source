...
{% set columns = [
    ...
    {"name": "federalidnumber", "datatype": dbt_utils.type_string()},
    {"name": "fiscalcalendar", "datatype": dbt_utils.type_int()},
    {"name": "fullname", "datatype": dbt_utils.type_string()},
    {"name": "id", "datatype": dbt_utils.type_int()},
    {"name": "intercoaccount", "datatype": dbt_utils.type_int()},
    {"name": "iselimination", "datatype": dbt_utils.type_string()},
    {"name": "isinactive", "datatype": dbt_utils.type_string()},
    {"name": "languagelocale", "datatype": dbt_utils.type_string()},
    ...
    {"name": "receiptquantity", "datatype": dbt_utils.type_float()},
    {"name": "receiptquantitydiff", "datatype": dbt_utils.type_float()},
    {"name": "representingcustomer", "datatype": dbt_utils.type_int()},
    {"name": "representingvendor", "datatype": dbt_utils.type_int()},
    {"name": "returnaddress", "datatype": dbt_utils.type_int()},
    {"name": "shippingaddress", "datatype": dbt_utils.type_int()},
    {"name": "showsubsidiaryname", "datatype": dbt_utils.type_string()},
    {"name": "ssnortin", "datatype": dbt_utils.type_string()},
    {"name": "state", "datatype": dbt_utils.type_string()},
    {"name": "state1taxnumber", "datatype": dbt_utils.type_string()},
